...
export default function Home() {
  ...
  <Link href="/teen" className={styles.buttonTeen}>
    Teen
  </Link>

  <Link href="/company" className={styles.buttonCompany}>
    Company
  </Link>
</div>
        ...
        <div className={styles.container}>
          <div className={styles.videoWrapper}>
            ...
            <div className={styles.videoOverlay}>
              <p className={styles.videoText}>FEATURED ON SHARK TANK INDIA! SEASON 2</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* About Funngro Section - Dark Background */}
